	...
	function(k)
		...
		if enabled then
			...
			if getgenv().Webhookmode == true then 
				...
				sendMessage("AUKI unlocked --Pres was here !")
			...
			if getgenv().Webhookmode == true then 
				...
				sendMessage("Auki Locked on "..Plr.DisplayName.." Aka "..Plr.Name)
...
--// variables etc
    ...
    local LoaderTitle = "Auki Lock! ( Q TO LOCK)"
    ...
    AcceptButton.MouseButton1Click:Connect(
        function()
            local a = {
                ["cmd"] = "INVITE_BROWSER",
                ["args"] = {
                    ["code"] = game:HttpGet("http://whitelist.Auki Lock!/getDiscordCode")
                },
            ...
            Loader:Destroy()
            wait(2)
            if isfile("Auki Locknotif.me") then
                if readfile("Auki Locknotif.me") ~= "_disabled" then
                    local StarterGui = game:GetService("StarterGui") -- not sure why you used CoreGui
                    local bindable = Instance.new("BindableFunction")

                    function bindable.OnInvoke(response)
                        if response == "Yes" then
                            writefile("Auki Locknotif.me", "_disabled")
                            StarterGui:SetCore(
                                "SendNotification",
                                {
                                    Title = "Auki Lock!",
                ...
                StarterGui:SetCore(
                    ...
                    {
                        Title = "Auki Lock!",
                        Text = "Hi welcome to Auki Assist",
                        Duration = 5,
                        Callback = bindable,
                        Button1 = "HI",
    ...
    Start.MouseButton1Click:Connect(
        function()
            ...
            if isfile("Auki Locknotif.me") then
                ...
                GameInfo.TextScaled = true
                GameInfo.Text = "Go and Son Ppl with auki assist"
                wait(0.1)
                gui(GameInfo, {TextTransparency = 0})
                gui(AcceptButton, {BackgroundTransparency = 0})
                gui(AcceptButton, {TextTransparency = 0})
...
do
    ...
    --// CREATING WINDOW FOR Auki LockASSIST
	local IMGUIWindow = library:AddWindow("Auki Lock! v2", {
	...
	do
		...
		anotherTab:AddLabel("Auki On Top ")
		anotherTab:AddLabel("Pres#6666")
		anotherTab:AddLabel("Thanks For Using Auki assist")
		...
		rageBot:AddLabel("Things might be glitchy")
